    ...
    <main>
      <section className="hero">
        <div className="hero-copy">
          <p className="eyebrow">Independent brand design studio</p>
          <h1>{heroHeadline}</h1>
          <p>{heroSubheadline}</p>
          <div className="hero-actions">
            <button className="primary-button" onClick={() => setCurrentPage("work")}>View Selected Work</button>
            <button className="secondary-button" onClick={() => setCurrentPage("contact")}>Start a Project</button>
          </div>
        </div>
